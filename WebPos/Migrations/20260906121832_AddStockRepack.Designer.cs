...
namespace WebPos.Migrations
{
    ...
    [Migration("20260906121832_AddStockRepack")]
    partial class AddStockRepack
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebPos.Core.Models.ProductRepackRecipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("SourceQtyPerTarget")
                        .HasColumnType("numeric(12,3)")
                        .HasColumnName("source_qty_per_target");
                    ...
                    b.HasIndex("TenantId", "SourceProductId", "TargetProductId")
                        .IsUnique();

                    b.ToTable("product_repack_recipes", (string)null);
                });
            ...
            modelBuilder.Entity("WebPos.Core.Models.StockRepack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("SourceQtyConsumed")
                        .HasColumnType("numeric(12,3)")
                        .HasColumnName("source_qty_consumed");

                    b.Property<Guid>("TargetProductId")
                        .HasColumnType("uuid")
                        .HasColumnName("target_product_id");

                    b.Property<decimal>("TargetQtyProduced")
                        .HasColumnType("numeric(12,3)")
                        .HasColumnName("target_qty_produced");
                    ...
                    b.ToTable("stock_repacks", (string)null);
                });

            modelBuilder.Entity("WebPos.Core.Models.StockRepackLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("StockRepackId")
                        .HasColumnType("uuid")
                        .HasColumnName("stock_repack_id");
                    ...
                    b.HasIndex("StockRepackId");

                    b.HasIndex("TenantId");

                    b.ToTable("stock_repack_lines", (string)null);
                });
            ...
            modelBuilder.Entity("WebPos.Core.Models.ProductRepackRecipe", b =>
                {
                    b.HasOne("WebPos.Core.Models.Product", "SourceProduct")
                        .WithMany()
                        .HasForeignKey("SourceProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebPos.Core.Models.Product", "TargetProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("WebPos.Core.Models.StockRepack", b =>
                {
                    b.HasOne("WebPos.Core.Models.User", "PerformedByUser")
                        .WithMany()
                        .HasForeignKey("PerformedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebPos.Core.Models.ProductRepackRecipe", "Recipe")
                        .WithMany("StockRepacks")
            ...
            modelBuilder.Entity("WebPos.Core.Models.StockRepackLine", b =>
                {
                    b.HasOne("WebPos.Core.Models.ProductBatch", "ProductBatch")
                        .WithMany("StockRepackLines")
                        .HasForeignKey("ProductBatchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebPos.Core.Models.StockRepack", "StockRepack")
                        .WithMany("Lines")
                        .HasForeignKey("StockRepackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebPos.Core.Models.ProductBatch", b =>
                {
                    ...
                    b.Navigation("StockRepackLines");
                });

            modelBuilder.Entity("WebPos.Core.Models.ProductRepackRecipe", b =>
                {
                    b.Navigation("StockRepacks");
                });
