...
namespace WebPos.Migrations
{
    ...
    [Migration("20260909161000_AddProductCatalogSearchIndexes")]
    partial class AddProductCatalogSearchIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebPos.Core.Models.Product", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Name")
                        .HasDatabaseName("IX_products_tenant_bulk_parents")
                        .HasFilter("is_bulk AND parent_product_id IS NULL AND is_deleted = FALSE");
