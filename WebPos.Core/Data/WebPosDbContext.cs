...
public class WebPosDbContext : DbContext
{
    ...
    public DbSet<PartyPaymentAllocation> PartyPaymentAllocations => Set<PartyPaymentAllocation>();
    ...
    private static void ConfigureCashAccount(EntityTypeBuilder<CashAccount> entity)
    {
        ...
        ValueConverter<CashAccountType, string> typeConverter = new(
            v => CashAccountTypes.ToStored(v),
            v => CashAccountTypes.FromStored(v));
        ...
        entity.HasIndex(e => new { e.TenantId, e.TerminalId })
            .IsUnique()
            .HasFilter("\"terminal_id\" IS NOT NULL")
            .HasDatabaseName("UX_cash_accounts_tenant_terminal");

        entity.HasIndex(e => new { e.TenantId, e.Type, e.SortOrder })
    ...
    private static void ConfigureShiftExpense(EntityTypeBuilder<ShiftExpense> entity)
    {
        ...
        entity.Property(e => e.Id).HasColumnName("id");
        entity.Property(e => e.ShiftId).HasColumnName("shift_id").IsRequired(false);
    ...
    private static void ConfigurePartyPaymentAllocation(EntityTypeBuilder<PartyPaymentAllocation> entity)
    {
        entity.ToTable("party_payment_allocations");

        entity.HasKey(e => e.Id);

        entity.Property(e => e.Id).HasColumnName("id");
        entity.Property(e => e.PartyLedgerId).HasColumnName("party_ledger_id").IsRequired();
        entity.Property(e => e.InvoiceNo).HasColumnName("invoice_no").HasMaxLength(100);
        entity.Property(e => e.PurchaseOrderId).HasColumnName("purchase_order_id");
        MapPaisa(entity.Property(e => e.AmountPaisa)).HasColumnName("amount_paisa").IsRequired();
        entity.Property(e => e.CreatedAt).HasColumnName("created_at").IsRequired();

        entity.HasOne(e => e.PartyLedger)
            .WithMany(l => l.Allocations)
            .HasForeignKey(e => e.PartyLedgerId)
            .OnDelete(DeleteBehavior.Cascade);
    ...
    private static void ConfigureProduct(EntityTypeBuilder<Product> entity)
    {
        ...
        entity.Property(e => e.ShortCode).HasColumnName("short_code").HasMaxLength(10).IsRequired().HasDefaultValue(string.Empty);
    ...
    private static void ConfigurePurchaseOrder(EntityTypeBuilder<PurchaseOrder> entity)
    {
        ...
        MapPaisa(entity.Property(e => e.AmountPaidPaisa)).HasColumnName("amount_paid_paisa").IsRequired();
